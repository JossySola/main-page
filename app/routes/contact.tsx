...
export async function action({
    ...
    const msg = {
        ...
        </tbody></table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="5de6d52f-8e96-420d-8075-fb1cd2a272ec" data-mc-module-version="2019-10-22">
            <tbody>
            <tr>
                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 24px"><strong>Message from Homepage</strong></span></div><div></div></div></td>
            </tr>
            </tbody>
        </table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a63946ad-3a4f-47b0-9d7f-b7c1900a8414" data-mc-module-version="2019-10-22">
            <tbody>
            <tr>
        ...
        <div style="font-family: inherit; text-align: inherit"><span style="font-family: helvetica, sans-serif; color: #afafaf; font-size: 14px"><strong>Email:</strong></span><span style="font-family: helvetica, sans-serif; color: #afafaf; font-size: 14px">${ email }</span></div><div></div></div></td>
            ...
            <tbody>
            <tr>
                <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: inherit"><span style="font-size: 18px">${ message }</span></div><div></div></div></td>
            </tr>
            </tbody>
...
export default function Contact ({
    ...
    return <section className="w-full h-screen flex flex-col justify-center gap-3">
        <h1 style={{ fontFamily: "Geist Bold" }} className="text-center text-3xl">Contact</h1>
        <ContactForm />
    </section>
}